...
import PropertyImpression from "@/app/components/property-impression";
...
export default async function PropertyPage({
  ...
  return (
    <>
      <PropertyImpression zpid={property.id} propertyData={property} />
                    ...
                    {property.schools.map((school, index) => (
                      <div key={index} className="p-4 border rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {school.type} • {school.grades} • {school.distance}
                        </p>
                      </div>
                    ))}
                  </div>
                          ...
                          {property.taxHistory.map((taxEntry, index) => (
                            <tr key={index} className="border-b">
                              ...
                              <td className="py-2 px-4">
                                {taxEntry.propertyTaxes}
                              </td>
                              <td className="py-2 px-4">
                                {taxEntry.taxAssessment}
                              </td>
                            </tr>
                          ))}
                        </tbody>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-xs text-center text-muted-foreground">
                      By submitting, you agree to our Terms of Use and Privacy
                      Policy
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {property.paymentCalculator.loanAmount}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Down payment</span>
                      <span className="font-medium">
                        {property.paymentCalculator.downPayment}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Interest rate</span>
                      <span className="font-medium">
                        {property.paymentCalculator.interestRate}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Loan term</span>
                      <span className="font-medium">
                        {property.paymentCalculator.loanTerm}
                      </span>
                    </div>
                    <div className="pt-4 border-t">
                      <div className="flex justify-between text-lg">
                        ...
                        <span className="font-bold">
                          {property.paymentCalculator.monthlyPayment}
                        </span>
                      </div>
                    </div>
                    <Button variant="outline" className="w-full">
